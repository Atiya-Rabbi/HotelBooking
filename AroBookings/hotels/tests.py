...
class DbQueriesTestCase(TestCase):
    ...
    def test_find_hotels_by_dest(self):
        result1 = FilterQuery().find_hotels_by_dest('city','Dublin')
    ...
    def test_hotel_details(self):
        ...
        details2 = FilterQuery().hotel_details(2)
    ...
    def test_find_hotels_by_facility(self):
        hotels = FilterQuery().find_hotels_by_facility(facilities_id=[1,2,3],city='New Delhi')
        self.assertEqual(len(hotels),1)

    def test_find_hotel_by_price(self):
        minprice = 100
        maxprice = 200
        hotels = FilterQuery().find_hotel_by_price(minprice,maxprice,'Dublin')
        self.assertEqual(len(hotels),1)
